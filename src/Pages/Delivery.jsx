...
export const Delivery = () => {
  return (
    <Flex w="70%" m="auto" justifyContent="space-between"  mt="30px" mb="30px">
        ...
        <Box w='30%'>
            <Button w='100%' display="flex"  bg="#10847e" color="white" fontSize='xl' p="25px" _hover={{ border: "1px solid #159a94" }} ><Text mr="10px"> Proceed to Pay </Text> <AiFillRightCircle w="50px"/></Button>
