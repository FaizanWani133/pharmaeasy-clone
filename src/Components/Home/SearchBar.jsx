...
function SearchBar() {
  return (
    ...
    />
    <Input paddingY="23px" focusBorderColor='grey' boxShadow= "rgb(0 0 0 / 8%) 0px 4px 7px" borderRadius="20px" type='text' placeholder='Search for'  />
    <InputRightElement width='5rem'  >
        <Button bg="#10847E" color="white" borderRadius="20px" height="40px" mr="3px" mt="7px"  >
          Search
        </Button>
      </InputRightElement>
  </InputGroup>
