...
function SearchBar() {
  ...
  return (
    ...
    />
    <Input paddingY="23px" focusBorderColor='grey' boxShadow= "rgb(0 0 0 / 8%) 0px 4px 7px" borderRadius="20px" type='text' placeholder='Search for' value={name} onChange={(e)=>setName(e.target.value)}  />
