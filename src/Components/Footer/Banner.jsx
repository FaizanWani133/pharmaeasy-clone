...
const Banner = () => {
  return (
    ...
    <Box position="relative" bgColor="#D7FAF8" width="100%" height="305px" display={{base:"none",md:"none",lg:"block"}}>
        ...
        <Box position="absolute" top="15px" left="33.5%" height="275px" width="33%" fontFamily="Inter,sans-serif" color="#30363C">
            <Text textAlign="center" fontSize="38px" lineHeight="48px" m="0" p="0" fontWeight="600">
                Simplifying
            </Text>
            <Text textAlign="center" fontSize="38px" lineHeight="48px"  m="0" p="0" fontWeight="600">
                Healthcare
            </Text>
            <Text textAlign="center" fontSize="38px" lineHeight="48px"  m="0 0 24px 0" p="0" fontWeight="600">
                Impacting Lives
            </Text>
            <Text textAlign="center" fontSize="20px" lineHeight="32px"  m="0 0 20px 0" p="0" fontWeight="600">
