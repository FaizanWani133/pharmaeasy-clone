...
function SearchBar() {
  return (
    ...
    <Box maxW={{base:"300px",sm:"600px",lg:"800px"}} margin="auto" pt="30px" pr="10px" pl="10px">
      <Box mb={4}><Text align={{base:"center",lg:"left"}} fontSize="20px" fontWeight="bold">What are you looking for?</Text></Box>
      <InputGroup>
    <InputLeftElement
    ...
    />
    <Input focusBorderColor='grey' boxShadow= "rgb(0 0 0 / 8%) 0px 4px 7px" borderRadius="20px" type='text' placeholder='Search for'  />
